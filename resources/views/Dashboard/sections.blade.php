                      ...
                      <div class="card-body">
                        ...
                        <table class="table">
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td>{{$section->section_title_en}}</td>
                              <td>{{$section->section_title_ar}}</td>
                              @if ($section->is_visable == true)
                              <td><label class="badge badge-success">Visable</label></td>
                              @else
                              <td><label class="badge badge-info">Unvisable</label></td>
                              @endif
                              <td>
                                <a href="{{route('adminsections.edit',$section->id)}}" class="btn btn-primary">Edit</a>
                                <a href="{{route('adminsections.details',$section->id)}}" class="btn btn-secondary">View Content</a>
                              </td>
                            </tr>
                            @endforeach
