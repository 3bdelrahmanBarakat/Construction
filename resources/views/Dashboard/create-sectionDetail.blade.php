        ...
        <div class="main-panel">
            <div class="content-wrapper">
                <div class="container-fluid">
                    ...
                    <!-- Section Update Form -->
                    <form action="{{ route('adminsections.store_detail', $section->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <!-- Section Title -->
                        <div class="form-group">
                            <label for="content_title_en">Title (English)</label>
                            <input type="text" class="form-control" id="content_title_en" name="content_title_en" >
                        </div>
                        <div class="form-group">
                            <label for="content_title_ar">Title (Arabic)</label>
                            <input type="text" class="form-control" id="content_title_ar" name="content_title_ar" >
                        </div>

                        <!-- Section Description -->
                        <div class="form-group">
                            <label for="content_description_en">Description (English)</label>
                            <textarea class="form-control" id="content_description_en" name="content_description_en"></textarea>
                        </div>
                        <div class="form-group">
                            <label for="content_description_ar">Description (Arabic)</label>
                            <textarea class="form-control" id="content_description_ar" name="content_description_ar"></textarea>
                        </div>
